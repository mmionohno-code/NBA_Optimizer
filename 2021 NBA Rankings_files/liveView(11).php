		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=121462&schain=1.0,1!tradehouse.media,11255,1&cbuster=296480292&cbuster=1775872841',
					origQString: 's=121462&schain=1.0,1!tradehouse.media,11255,1&cbuster=296480292',
					placementId: 121462,
					x: 300,
					y: 250,
					videoType: 'sticky',
